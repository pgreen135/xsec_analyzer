...
void test_unfolding() {
  ...
  std::cout << "Fake data: " << using_fake_data << std::endl;
  ...
  */
  ...
  dump_overall_results( result, unfolded_cov_matrix_map, 1e39 / conv_factor,
  ...
  for ( size_t sl_idx = 0u; sl_idx < sb.slices_.size(); ++sl_idx ) {
    ...
    slice_unf->hist_->SetTitle("Genie Fake Data");
    ...
    slice_unf->hist_->GetYaxis()->SetRangeUser( 0., 1) ;//ymax*1.07 );
