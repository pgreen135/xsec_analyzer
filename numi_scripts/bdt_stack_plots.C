...
void bdt_stack_plots() {

  auto* syst_ptr = new MCC9SystematicsCalculator(
    // Retrained BDTs
    //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_rhc_bdt1_withData.root",
    //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_rhc_bdt2_withData.root",
    //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_fhc_bdt1_withData.root",
  ...
  TH1D *h_ratio_error_values = (TH1D*)slice_mc_plus_ext->hist_.get()->Clone("h_ratio_error_values");
  
  for(int i=0 ; i <= h_ratio_error_values->GetNbinsX() ; i++){
    h_ratio_error_values->SetBinError(i, 0);
  }
  
  h_ratio->Divide(slice_mc_plus_ext->hist_.get());
  h_ratio_error->Divide(h_ratio_error_values);
  ...
  total_frac_err_hist->SetTitle("RHC");
