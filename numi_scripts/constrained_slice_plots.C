...
void slice_plots()
{
    ...
    //auto* sb_ptr = new SliceBinning( "../nuecc1pi_sideband_total_slice_config.txt" );
    //auto* sb_ptr = new SliceBinning( "../nuecc1pi_sideband_electron_energy_slice_config.txt" );
    //auto* sb_ptr = new SliceBinning( "../nuecc1pi_sideband_pion_angle_slice_config.txt" );
   ...
   // Get the object constaining all the selection and uncertainty information
    auto *syst_ptr = new MCC9SystematicsCalculator(
        ...
        // Full
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_full_noProton.root",
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_full.root", // loose proton
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_full_looseProton_noAngle.root",
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_full_looseProton_noPionAngle.root",
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_full_looseProton_noElecAngle.root",
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_full_strictProton.root",
        
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_extraLooseProtonSideband.root",
        ...
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_full_both_noAngleTest1.root",

        // Total
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_total_noProton.root",
        ...
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_total_strictProton.root",

        // Electron energy
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_electron_energy_noProton.root",
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_electron_energy_looseProton.root",
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_electron_energy_strictProton.root",

        // Pion angle
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_pion_angle_looseProton.root",

        // Electron angle
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_electron_angle_noProton.root",
        //"/Users/patrick/Documents/MicroBooNE/CrossSections/NuePiXSec_Analysis/XSecAnalyzer/univmake_output/univmake_output_combined_nuecc1pi_withData_sideband_electron_angle_looseProton.root",
    ...
    const auto &data_covmat = meas.cov_matrix_; // Covariance matrix for MC+EXT prediction
    ...
    TH1D* reco_mc_plus_ext_hist_constr = dynamic_cast< TH1D* >(reco_ext_hist->Clone("reco_mc_plus_ext_hist_constr") );
    ...
    */
    ...
    for (size_t sl_idx = 0u; sl_idx < sb.slices_.size(); ++sl_idx)
    {
        ...
        std::cout << "Bin 1 error: " << h_ratio_constr->GetBinError(1) << std::endl;
